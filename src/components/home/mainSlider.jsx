  ...
  return (
    <section className="Main_slider">
      <Slider {...settings}>
        {[0, 1, 2].map((_item, idx) => {
          return (
            idx === 0 ? <div class="video-container" key={idx}>
              <iframe src="https://www.youtube.com/embed/Yj2iELI6OeI?autoplay=1&mute=1&loop=1&playlist=Yj2iELI6OeI&playsinline=1&controls=0&modestbranding=1" allow="autoplay; encrypted-media" allowfullscreen></iframe>
