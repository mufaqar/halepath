        ...
        <section className='md:py-28 py-24 relative bg-center bg-no-repeat bg-cover before:content-[""] before:absolute before:w-full before:bg-[url("/images/qoute-overlay.png")]  before:h-full before:top-0' style={{ backgroundImage: `url("/images/qoute-bg.png")` }}>
            <div className='container mx-auto px-4 relative z-10 flex md:flex-row flex-col gap-7'>
                ...
                <div className='md:w-1/2 w-full'>
                    ...
                    <form className="grid w-full gap-6 items-center mt-5 bg-primary md:p-11 p-6 rounded-[19px]">
                        <div className='w-full flex md:flex-row flex-col gap-6'>
                            <div className="w-full flex flex-col">
                                <label htmlFor='fullname' className="text-sm font-medium leading-none hidden">Full Name</label>
                                <input
                                    className="text-lg md:leading-[56px] font-normal text-[#7C7C7C] placeholder:text-[#7C7C7C] bg-white px-7 py-2 border border-transparent focus:border-secondary outline-none rounded-full w-full"
                                    type="text"
                                    name="fullname"
                                    id='fullname'
                        ...
                        <div className='w-full flex md:flex-row flex-col gap-6'>
                            ...
                            <div className="w-full flex flex-col">
                                ...
                                <select
                                    className="text-lg md:leading-[56px] font-normal text-[#7C7C7C] placeholder:text-[#7C7C7C] bg-white px-7 py-2 border border-transparent focus:border-secondary outline-none rounded-full w-full md:min-h-[75px] h-[46px]"
                                    name="product"
                                    id='product'>
                        ...
                        <div className="w-full">
                            <button type='submit' className="text-lg md:leading-[56px] font-normal text-white bg-secondary px-7 py-2 border border-transparent focus:border-secondary outline-none rounded-full w-full">
                                SUBMIT
                            </button>
                        </div>
                    </form>
