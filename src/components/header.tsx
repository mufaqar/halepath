...
function Header() {
  ...
  return (
    <>
      {/* Top bar */}
      <div className="bg-secondary py-3 md:block hidden">
        ...
        <section className="">
          <div className="container mx-auto px-4 py-1 flex gap-5 items-center justify-between">
            ...
            <nav className="lg:w-[61%] w-1/2 flex items-center justify-end">
              ...
              <ul
                className={`lg:gap-6 gap-5 lg:items-center lg:justify-between lg:static lg:flex-row flex-col lg:px-0 lg:py-0 px-4 py-8 lg:bg-transparent ${
                  openNav === true
                ...
                {NavLinks?.map((item, idx) => {
                  return (
                    ...
                    >
                      <Link
                        href={`${item?.link}`}
                        className="text-base font-medium text-title_Clr group-hover:text-primary"
                      >
                        {item?.name}
                      </Link>
                      {item?.submenu && (
                        <span>
                          <BsChevronDown className="ml-1 inline-block text-sm font-normal text-title_Clr group-hover:text-primary" />
                        </span>
                      )}
            ...
            <div className="lg:w-[24%] lg:flex gap-5 justify-end hidden">
              ...
              <Link
                href="/get-qoute"
                className="bg-primary hover:bg-transparent px-5 py-2.5 text-base uppercase font-medium text-white hover:text-primary rounded-full border-2 border-primary"
              >
                Get a Quote
              </Link>
            </div>
